...
int main(int argc, char *argv[])
{
	...
	else
	{
		if( leidoOK == true )
		{
			...
			std::cout << "Memoization: nuse" ;
			std::cout  << std::endl;
			
			std::cout << "Iterative: nuse";
			std::cout  << std::endl;
			
			std::cout << "Iterative (vectors): nuse";
			std::cout  << std::endl;
			
			if( flags[1] == true )
			{
				std::cout << "Iterative table: nuse";
				std::cout  << std::endl;
			}
			
			if( flags[0] == true )
			{
				std::cout << "A posible path: nuse";
				std::cout  << std::endl;
			}
			
			std::cout << "weight: nuse";
			std::cout  << std::endl;
		}
		else
		{
